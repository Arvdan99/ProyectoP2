...
class LibrosController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        Libros.append(Libro(nombre: "Harry Potter y la Cámara Secreta", año: "1998", genero: "Fantasía", autor: "J.K Rowling", ediciones: Ediciones2, paginas: "288", encuadernacion: "Tapa blanda", copiasv: "60 Milones", precio: "$649", imagen: "CamaraSecreta", imagen2: "CamaraSecreta2"))
        ...
        Libros.append(Libro(nombre: "El resplandor", año: "1977", genero: "Terror", autor: "Stephen King", ediciones: Ediciones4, paginas: "643", encuadernacion: "Tapa blanda", copiasv: "350 Milones", precio: "$499", imagen: "Resplandor", imagen2: "Resplandor2"))
